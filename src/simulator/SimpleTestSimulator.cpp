...
SimpleTestSimulator::SimpleTestSimulator()
{
    ...
    events_.push_back(WeatherCell(1, 1002, WeatherSeverity::OK));
    ...
    events_.push_back(WeatherCell(1, 2002, WeatherSeverity::SEVERE));
    ...
    events_.push_back(WeatherCell(1, 3002, WeatherSeverity::SEVERE));
}
